...
# Online film izleme platformu daha önce hazırladığı tavsiye sistemini
# geliştirmek istemektedir.

# İçerik temelli öneri sistemlerini ve item-based öneri sistemlerini deneyen
# şirket kullanıcılara daha fazla özelleştirilme yapılmasını istemektedir.

# Genel önerileri kullanıcıların kullanıcılara benzerliği üzerinden
# daha fazla özelleştirmek istemektedir.


###############################################################
# Veri Seti Hikayesi
###############################################################
# Veri seti MovieLens isimli bir firma tarafındna sağlanmıştır.
# Filmler ve bu filmlere verilen puanları barındırmaktadır.
# yaklaşık 27000 film için 2000000 derecelendirme bulunuyor.
...
# Adım 5: Weighted Average Recommendation Score'un Hesaplanması
#############################################
#Korelasyon ve rating in etkisini göz önüne almak istiyoruz.
...
user_based_recommender(random_user, user_movie_df, cor_th=0.70, score=3.5)
